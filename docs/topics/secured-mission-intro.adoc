...
* The sources for the Greeting service, which we are going to secure.
...
a|
Allows the end user to deploy the Red Hat SSO module without needing to know the internals or how to configure Red Hat SSO.
