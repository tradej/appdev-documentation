...
For further reading on reactive systems, reactive programming, and reactive extensions, see the xref:vertx-additional-resources_{context}[Additional Resources] section.
